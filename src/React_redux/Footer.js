...
const mapStateFooter = state => ({
    itemsAmount: state.items.length,
    removedItemsAmount: state.removedItems.length,
    createdItemsAmount: state.currentIndex,
});

Footer = ReactRedux.connect(mapStateFooter)(Footer);